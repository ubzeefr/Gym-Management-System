...
<html lang="en">
  ...
  <body>
    ...
    <table class="table table-hover table-dark" style="font-size: smaller;">
      ...
      <div class="text-center"><input type="button" class="btn btn-lg btn-danger" onclick="location.href='admin-workout-change.php'" value="Edit Workout" style="width: 25%;" /></div>
