          ...
          <div class="row g-0">
            ...
            <div class="col-xl-6">
              <div class="card-body p-md-5 text-black">
                <h3 class="mb-5 text-uppercase">Edit User</h3>
                ...
                <div class="form-outline mb-4">
                <input class="form-control" type="text" placeholder="YYYY-mm-dd" name="start_date">
            ...
            <option value="Aerobics">Aerobics</option>
                ...
                <div class="form-outline mt-4">
                <select class="form-select form-control form-control-lg text-center" aria-label="Default select example" name="status">
