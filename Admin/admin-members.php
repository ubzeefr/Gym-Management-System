<?php
        ...
        if(isset($_REQUEST['delete'])){
          ...
          $pawan = $_REQUEST['Username'];

          $conn1 = mysqli_connect('localhost','root', '', 'Gym'); 

          $sql = "DELETE FROM Member WHERE username = '$pawan'";
    ...
    <table class="table table-hover table-dark">
         <thead> <!--  table-fit -->
          ...
          <?php 
            ...
            $query = "SELECT * FROM (Member natural join Trainer) natural join Category";
            ...
            if ($result = mysqli_query($conn,$query)) { 
                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                    ...
                    // $field4name = $row["start_date"];
                    // $field5name = $row["duration"]; 
                    // $field6name = $row["tid"]; 
                    // $field7name = $row["slot"]; 
                    // $field8name = $row["c_name"];
                    ...
                    echo '<tr> 
                            ...
                            <td><a href="admin-edit-members.php?username='.$user.'"><button class="btn btn-sm btn-success">
                            Edit</button></td>
                            
                            <td><form action="" method="POST"><input type="hidden" name="Username" value=' . $row["username"] . '><input type="submit" class="btn btn-sm btn-danger" name="delete" value="Delete"></form></td>
